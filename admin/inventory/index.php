  ...
  <div class="container mx-auto p-6">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex gap-3">
        ...
        <a href="add.php" id="openFeedModal" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold">
          Add Feed Stock
        </a>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <table class="w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr class="hover:bg-gray-50">
                <td class="px-6 py-4 font-semibold text-gray-900"><?php echo htmlspecialchars($row['feed_type']); ?></td>
                <td class="px-6 py-4 text-gray-700"><?php echo number_format($row['quantity_kg'], 2); ?> kg</td>
                <td class="px-6 py-4">
                  <span class="px-3 py-1 inline-flex text-xs font-semibold rounded-full <?php echo $stock_colors[$row['stock_status']]; ?>">
      ...
      <?php else: ?>
        <div class="text-center py-12 text-gray-500">No feed inventory found.</div>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div id="feedModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-3xl overflow-hidden">
      <div class="flex justify-between items-center border-b px-6 py-4">
        ...
        <button id="closeFeedModal" class="text-gray-500 hover:text-gray-700 text-2xl">&times;</button>
      </div>

      <!-- Load add.php form inside iframe -->
      <iframe src="add.php" class="w-full h-[600px]" frameborder="0"></iframe>
    </div>
  </div>
